...
public class FrontendOptions extends LexerOptions implements ParserOptions {
    ...
    FeatureExpr getFilePresenceCondition() {
        if (filePC == null)
            filePC = new FeatureExprParser(FeatureExprFactory$.MODULE$.dflt(), null, null).parseFile(getFilePresenceConditionFilename());
        return filePC;
    }
    ...
    FeatureExpr getLocalFeatureModel() {
        if (localFM == null)
            localFM = new FeatureExprParser(FeatureExprFactory$.MODULE$.dflt(), null, null).parseFile(getLocalFeatureModelFilename());
        return localFM;
    }
